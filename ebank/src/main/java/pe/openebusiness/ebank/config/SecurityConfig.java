...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   public void configure(HttpSecurity http) throws Exception {
      http.addFilterBefore(corsFilter(), SessionManagementFilter.class)
         ...
         .antMatchers("/user/getUserDataTable/*").hasRole("TEST")
         .antMatchers("/user/getUsers").hasRole("TEST")
         .antMatchers("/user/getUserByName/*").hasRole("TEST")
         .antMatchers("/user/saveUser/*").hasRole("TEST")
		 .antMatchers("/user/enableUsers/*").hasRole("TEST")
